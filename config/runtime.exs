...
#
#     PHX_SERVER=true bin/acc_tournament start
#
...
config :imgproxy,
  prefix: System.get_env("IMGPROXY_URL"),
...
if config_env() == :prod do
  ...
  config :acc_tournament, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :acc_tournament, AccTournament.Mailer,
