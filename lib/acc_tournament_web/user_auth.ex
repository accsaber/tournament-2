defmodule AccTournamentWeb.UserAuth do
  use AccTournamentWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_acc_tournament_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AccTournamentWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule AccTournamentWeb.PageLive do
        use AccTournamentWeb, :live_view

        on_mount {AccTournamentWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AccTournamentWeb.UserAuth, :ensure_authenticated}] do
