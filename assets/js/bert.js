 ...
 */
function utf8_dec(buffer) {
  return new TextDecoder().decode(buffer);
}
function utf8_enc(buffer) {
  return new TextEncoder("utf-8").encode(buffer);
}
...
export function decode(buffer) {
  ...
  function decode_iee() {
    let result = read_Float(
      new Uint8Array(data.buffer.slice(index, index + 8)),
      0,
      false,
      52,
      8
  ...
  function decode_type() {
    ...
    switch (type) {
      ...
      case 70:
        return decode_iee();
      case 100:
        return decode_string_16();
      case 104:
        return decode_tuple_8();
      case 107:
        return decode_charlist();
      case 108:
        return decode_list_32();
      case 109:
        return decode_string_32();
      case 110:
        return decode_small_bignum();
      case 111:
        return decode_big_bignum();
      case 115:
        return decode_string_8();
      case 118:
        return decode_string_16();
      case 119:
        return decode_string_8();
      case 105:
        return decode_tuple_32();
      case 116:
        return decode_map();
      default:
        return [];
  ...
  if (data.getUint8(index) !== 131) throw "BERT?";
